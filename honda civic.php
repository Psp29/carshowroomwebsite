...
<body>
    <header>
        ...
        <br>
        <br>
        <h3 class="rec3">Honda Civic </h3>
        <div id="honda_civic" class="carousel slide" data-ride="carousel">

            <!-- Indicators -->
            <ul class="carousel-indicators">
                <li data-target="#honda_civic" data-slide-to="0" class="active"></li>
                <li data-target="#honda_civic" data-slide-to="1"></li>
                <li data-target="#honda_civic" data-slide-to="2"></li>
                <li data-target="#honda_civic" data-slide-to="3"></li>
            </ul>

            <!-- The slideshow -->
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/models/Honda/civic/honda_civic_1.jpg" alt="Front">
                    <div class="carousel-caption">
                        <h3>Front-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Honda/civic/honda_civic_2.jpg" alt="Side">
                    <div class="carousel-caption">
                        <h3>Side-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Honda/civic/honda_civic_3.jpg" alt="Rear">
                    <div class="carousel-caption">
                        <h3>Rear-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Honda/civic/honda_civic_4.jpg" alt="interior">
                    <div class="carousel-caption">
                        <h3>Interior-View</h3>
                    </div>
                </div>
            ...
            <a class="carousel-control-prev" href="#honda_civic" data-slide="prev">
                <span class="carousel-control-prev-icon"></span>
            </a>
            <a class="carousel-control-next" href="#honda_civic" data-slide="next">
        ...
        <div class="container" style="color: white; background: rgba(0, 0, 0, 0.2);">
            <h2>Honda Civic Key Specifications: </h2>
            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-dark table-hover" style="white-space:nowrap;">
                                ...
                                <tbody style="white-space:nowrap; border: 1px solid white; border-radius:10px">
                                    <tr>
                                        <td>₹ 17.95 Lakh onwards</td>
                                        <td>16.5 to 23.9 kmpl</td>
                                        <td>1597 to 1799 cc</td>
                                        <td>Automatic (CVT) & Manual</td>
                                        <td>Petrol & Diesel</td>
                                        <td>5 Seater</td>
                                    </tr>
                                </tbody>
                ...
                <div class="col-sm-6">
                    <h1>Honda Civic Price</h1>
                    <p>Honda Civic price starts at ₹ 17.95 Lakh and goes upto ₹ 22.36 Lakh. The price of Petrol version for Civic ranges between ₹ 17.95 Lakh - ₹ 21.26 Lakh and the price of Diesel version for Civic ranges between ₹ 20.76 Lakh - ₹ 22.36 Lakh.</p>
                </div>
            </div>
            <br>
            <br>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="model" class="form-control">
                        ...
                        <option value="Honda Civic V CVT Petrol"> Honda Civic V CVT Petrol ₹ ₹ 17.95 Lakh </option>
                        <option value="Honda Civic VX MT Diesel"> Honda Civic VX MT Diesel ₹ 20.76 Lakh </option>
                        <option value="Honda Civic ZX CVT Petrol">Honda Civic ZX CVT Petrol ₹ 21.36 Lakh </option>
                        <option value="Honda Civic ZX MT Diesel">Honda Civic ZX MT Diesel ₹ 22.36 lakh </option>
                    </select>
                </div>
