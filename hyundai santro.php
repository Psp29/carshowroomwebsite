...
<body>
    <header>
        ...
        <br>
        <br>
        <h3 class="rec3">Hyundai Santro </h3>
        <div id="Hyundai_Santro" class="carousel slide" data-ride="carousel">

            <!-- Indicators -->
            <ul class="carousel-indicators">
                <li data-target="#Hyundai_Santro" data-slide-to="0" class="active"></li>
                <li data-target="#Hyundai_Santro" data-slide-to="1"></li>
                <li data-target="#Hyundai_Santro" data-slide-to="2"></li>
                <li data-target="#Hyundai_Santro" data-slide-to="3"></li>
            </ul>

            <!-- The slideshow -->
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/models/Hyundai/Santro/Hyundai_Santro_1.jpg" alt="Front">
                    <div class="carousel-caption">
                        <h3>Front-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Hyundai/Santro/Hyundai_Santro_2.jpg" alt="Side">
                    <div class="carousel-caption">
                        <h3>Side-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Hyundai/Santro/Hyundai_Santro_3.jpg" alt="Rear">
                    <div class="carousel-caption">
                        <h3>Rear-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Hyundai/Santro/Hyundai_Santro_4.jpg" alt="interior">
                    <div class="carousel-caption">
                        <h3>Interior-View</h3>
                    </div>
                </div>
            ...
            <a class="carousel-control-prev" href="#Hyundai_Santro" data-slide="prev">
                <span class="carousel-control-prev-icon"></span>
            </a>
            <a class="carousel-control-next" href="#Hyundai_Santro" data-slide="next">
        ...
        <div class="container" style="color: white; background: rgba(0, 0, 0, 0.2);">
            <h2>Hyundai Santro Key Specifications: </h2>
            <div class="row">
                ...
                <div class="col-sm-6">
                    <h1>Hyundai Santro Price</h1>
                    <p>Hyundai Santro price starts at ₹ 4.64 Lakh and goes upto ₹ 6.32 Lakh. The price of Petrol version for Santro ranges between ₹ 4.64 Lakh - ₹ 6.32 Lakh and the price of CNG version for Santro ranges between ₹ 5.87 Lakh - ₹ 6.01 Lakh.</p>
                </div>
            </div>
            <br>
            <br>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="model" class="form-control">
                        ...
                        <option value="Hyundai Santro Era Executive"> Santro Era Executive ₹ 4.64 Lakh </option>
                        <option value="Hyundai Santro Magna CNG"> Santro Magna CNG ₹ 5.87 Lakh </option>
                        <option value="Hyundai Santro Sportz CNG"> Santro Sportz CNG ₹ 6.01 Lakh </option>
                        <option value="Hyundai Santro Asta AMT"> Santro Asta AMT ₹ 6.32 Lakh </option>
                    </select>
                </div>
