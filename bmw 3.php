...
<body>
    <header>
        ...
        <br>
        <br>
        <h3 class="rec3">BMW 3 Series </h3>
        <div id="bmw_3" class="carousel slide" data-ride="carousel">

            <!-- Indicators -->
            <ul class="carousel-indicators">
                <li data-target="#bmw_3" data-slide-to="0" class="active"></li>
                <li data-target="#bmw_3" data-slide-to="1"></li>
                <li data-target="#bmw_3" data-slide-to="2"></li>
                <li data-target="#bmw_3" data-slide-to="3"></li>
            </ul>

            <!-- The slideshow -->
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/models/BMW/3/bmw_3_1.jpg" alt="Front">
                    <div class="carousel-caption">
                        <h3>Front-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/BMW/3/bmw_3_2.jpg" alt="Side">
                    <div class="carousel-caption">
                        <h3>Side-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/BMW/3/bmw_3_3.jpg" alt="Rear">
                    <div class="carousel-caption">
                        <h3>Rear-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/BMW/3/bmw_3_4.jpg" alt="interior">
                    <div class="carousel-caption">
                        <h3>Interior-View</h3>
                    </div>
                </div>
            ...
            <a class="carousel-control-prev" href="#bmw_3" data-slide="prev">
                <span class="carousel-control-prev-icon"></span>
            </a>
            <a class="carousel-control-next" href="#bmw_3" data-slide="next">
        ...
        <div class="container" style="color: white; background: rgba(0, 0, 0, 0.2);">
            <h2>BMW 3 Series Key Specifications: </h2>
            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-dark table-hover" style="white-space:nowrap;">
                                ...
                                <tbody style="white-space:nowrap; border: 1px solid white; border-radius:10px">
                                    <tr>
                                        <td>₹ 41.70 Lakh onwards</td>
                                        <td>16.13 to 20.37 kmpl</td>
                ...
                <div class="col-sm-6">
                    <h1>BMW 3 Series Price</h1>
                    <p>BMW 3 Series price starts at ₹ 41.70 Lakh and goes upto ₹ 48.49 Lakh. The price of Petrol version for 3 Series ranges between ₹ 41.70 Lakh - ₹ 48.49 Lakh and the price of Diesel version for 3 Series ranges between ₹ 42.10 Lakh - ₹ 47.50 Lakh.</p>
                </div>
            </div>
            <br>
            <br>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="model" class="form-control">
                        ...
                        <option value="BMW 3 Series 330i Sport"> 330i Sport ₹ 41.70 Lakh </option>
                        <option value="BMW 3 Series 320d Sport"> 320d Sport ₹ 42.10 Lakh </option>
                        <option value="BMW 3 Series 320d Luxury Line">320d Luxury Line ₹ 47.50 Lakh </option>
                        <option value="BMW 3 Series 330i M Sport"> 330i M Sport ₹ 48.49 Lakh </option>
                    </select>
                </div>
