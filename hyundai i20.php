...
<body>
    <header>
        ...
        <br>
        <br>
        <h3 class="rec3">Hyundai i20 </h3>
        <div id="Hyundai_i20" class="carousel slide" data-ride="carousel">

            <!-- Indicators -->
            <ul class="carousel-indicators">
                <li data-target="#Hyundai_i20" data-slide-to="0" class="active"></li>
                <li data-target="#Hyundai_i20" data-slide-to="1"></li>
                <li data-target="#Hyundai_i20" data-slide-to="2"></li>
                <li data-target="#Hyundai_i20" data-slide-to="3"></li>
            </ul>

            <!-- The slideshow -->
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/models/Hyundai/i20/Hyundai_i20_1.jpg" alt="Front">
                    <div class="carousel-caption">
                        <h3>Front-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Hyundai/i20/Hyundai_i20_2.jpg" alt="Side">
                    <div class="carousel-caption">
                        <h3>Side-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Hyundai/i20/Hyundai_i20_3.jpg" alt="Rear">
                    <div class="carousel-caption">
                        <h3>Rear-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Hyundai/i20/Hyundai_i20_4.jpg" alt="interior">
                    <div class="carousel-caption">
                        <h3>Interior-View</h3>
                    </div>
                </div>
            ...
            <a class="carousel-control-prev" href="#Hyundai_i20" data-slide="prev">
                <span class="carousel-control-prev-icon"></span>
            </a>
            <a class="carousel-control-next" href="#Hyundai_i20" data-slide="next">
        ...
        <div class="container" style="color: white; background: rgba(0, 0, 0, 0.2);">
            <h2>Hyundai i20 Key Specifications: </h2>
            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-dark table-hover" style="white-space:nowrap;">
                                ...
                                <tbody style="white-space:nowrap; border: 1px solid white; border-radius:10px">
                                    <tr>
                                        <td>₹ 6.80 Lakh onwards</td>
                                        <td>19.65 to 25.2 kmpl</td>
                                        <td>998 to 1493 cc</td>
                                        <td>Manual, Automatic (CVT), Clutchless Manual & Automatic (Dual Clutch)</td>
                                        <td>Petrol & Diesel</td>
                                        <td>5 Seater</td>
                                    </tr>
                                </tbody>
                ...
                <div class="col-sm-6">
                    <h1>Hyundai i20 Price</h1>
                    <p>Hyundai i20 price starts at ₹ 6.80 Lakh and goes upto ₹ 11.33 Lakh. The price of Petrol version for i20 ranges between ₹ 6.80 Lakh - ₹ 11.33 Lakh and the price of Diesel version for i20 ranges between ₹ 8.20 Lakh - ₹ 10.75 Lakh.</p>
                </div>
            </div>
            <br>
            <br>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="model" class="form-control">
                        ...
                        <option value="Hyundai i20 Magna 1.2 MT"> i20 Magna 1.2 MT ₹ 6.80 Lakh </option>
                        <option value="Hyundai i20 Magna 1.5 MT Diesel"> i20 Magna 1.5 MT Diesel ₹ 8.20 Lakh </option>
                        <option value="Hyundai i20 Asta (O) 1.5 MT Diesel Dual Tone"> i20 Asta (O) 1.5 MT Diesel Dual Tone ₹10.75 Lakh </option>
                        <option value="Hyundai i20 Asta (O) 1.0 Turbo DCT Dual Tone"> i20 Asta (O) 1.0 Turbo DCT Dual Tone ₹ 11.33 Lakh </option>
                    </select>
                </div>
