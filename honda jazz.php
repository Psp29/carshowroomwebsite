...
<body>
    <header>
        ...
        <br>
        <br>
        <h3 class="rec3">Honda Jazz </h3>
        <div id="honda_jazz" class="carousel slide" data-ride="carousel">

            <!-- Indicators -->
            <ul class="carousel-indicators">
                <li data-target="#honda_jazz" data-slide-to="0" class="active"></li>
                <li data-target="#honda_jazz" data-slide-to="1"></li>
                <li data-target="#honda_jazz" data-slide-to="2"></li>
                <li data-target="#honda_jazz" data-slide-to="3"></li>
            </ul>

            <!-- The slideshow -->
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/models/Honda/jazz/honda_jazz_1.jpg" alt="Front">
                    <div class="carousel-caption">
                        <h3>Front-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Honda/jazz/honda_jazz_2.jpg" alt="Side">
                    <div class="carousel-caption">
                        <h3>Side-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Honda/jazz/honda_jazz_3.jpg" alt="Rear">
                    <div class="carousel-caption">
                        <h3>Rear-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Honda/jazz/honda_jazz_4.jpg" alt="interior">
                    <div class="carousel-caption">
                        <h3>Interior-View</h3>
                    </div>
                </div>
            ...
            <a class="carousel-control-prev" href="#honda_jazz" data-slide="prev">
                <span class="carousel-control-prev-icon"></span>
            </a>
            <a class="carousel-control-next" href="#honda_jazz" data-slide="next">
        ...
        <div class="container" style="color: white; background: rgba(0, 0, 0, 0.2);">
            <h2>Honda Jazz Key Specifications: </h2>
            <div class="row">
                ...
                <div class="col-sm-6">
                    <h1>Honda Jazz Price</h1>
                    <p>Honda jazz price starts at ₹ 17.95 Lakh and goes upto ₹ 22.36 Lakh. The price of Petrol version for jazz ranges between ₹ 17.95 Lakh - ₹ 21.26 Lakh and the price of Diesel version for jazz ranges between ₹ 20.76 Lakh - ₹ 22.36 Lakh.</p>
                </div>
            </div>
            <br>
            <br>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="model" class="form-control">
                        ...
                        <option value="Honda jazz V CVT Petrol"> Honda jazz V CVT Petrol ₹ ₹ 17.95 Lakh </option>
                        <option value="Honda jazz VX MT Diesel"> Honda jazz VX MT Diesel ₹ 20.76 Lakh </option>
                        <option value="Honda jazz ZX CVT Petrol">Honda jazz ZX CVT Petrol ₹ 21.36 Lakh </option>
                        <option value="Honda jazz ZX MT Diesel">Honda jazz ZX MT Diesel ₹ 22.36 lakh </option>
                    </select>
                </div>
