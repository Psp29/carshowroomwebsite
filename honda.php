...
<body>
    <header>
        ...
        <br>
        <br>
        <h4 id="rec1">&nbsp;&nbsp;&nbsp;Available Honda Cars: </h2>
            <div class="row" id="ads">
                <div class="col-md-3">
                    <div class="card rounded">
                        <div class="card-image">
                            <span class="card-notify-year">2019</span>
                            <img class="img-fluid" src="./images/models/Honda/amaze/honda_amaze.jpg" alt="Alternate Text" />
                        </div>
                        <div class="card-image-overlay m-auto">
                            <span class="card-detail-badge">New</span>
                            <span class="card-detail-badge">₹ 6.19 - ₹ 10.01 Lakh</span>
                        </div>
                        <div class="card-body text-center">
                            <div class="ad-title m-auto">
                                <h5>Honda Amaze</h5>
                            </div>
                            <a class="ad-btn" href="honda amaze.php">View</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card rounded">
                        <div class="card-image">
                            <span class="card-notify-year">2019</span>
                            <img class="img-fluid" src="./images/models/Honda/civic/honda_civic.jpg" alt="Alternate Text" />
                        </div>
                        <div class="card-image-overlay m-auto">
                            <span class="card-detail-badge">New</span>
                            <span class="card-detail-badge">₹ 17.95 - ₹ 22.36 Lakh</span>
                        </div>
                        <div class="card-body text-center">
                            <div class="ad-title m-auto">
                                <h5>Honda Civic</h5>
                            </div>
                            <a class="ad-btn" href="honda civic.php">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card rounded">
                        <div class="card-image">
                            <span class="card-notify-year">2019</span>
                            <img class="img-fluid" src="./images/models/Honda/jazz/honda_jazz.jpg" alt="Alternate Text" />
                        </div>
                        <div class="card-image-overlay m-auto">
                            <span class="card-detail-badge">New</span>
                            <span class="card-detail-badge">₹ 7.61 - ₹ 9.84 Lakh</span>
                        </div>
                        <div class="card-body text-center">
                            <div class="ad-title m-auto">
                                <h5>Honda Jazz</h5>
                            </div>
                            <a class="ad-btn" href="honda jazz.php">View</a>
                        </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="card rounded">
                        <div class="card-image">
                            <span class="card-notify-year">2019</span>
                            <img class="img-fluid" src="./images/models/Honda/city/honda_city.jpg" alt="Alternate Text" />
                        </div>
                        <div class="card-image-overlay m-auto">
                            <span class="card-detail-badge">New</span>
                            <span class="card-detail-badge">9.30 - 10.00 Lakh</span>
                        </div>
                        <div class="card-body text-center">
                            <div class="ad-title m-auto">
                                <h5>Honda City</h5>
                            </div>
                            <a class="ad-btn" href="honda city.php">View</a>
                        </div>
                    </div>
