...
<body>
    <header>
        ...
        <br>
        <br>
        <h3 class="rec3">BMW Z4 </h3>
        <div id="bmw_Z4" class="carousel slide" data-ride="carousel">

            <!-- Indicators -->
            <ul class="carousel-indicators">
                <li data-target="#bmw_Z4" data-slide-to="0" class="active"></li>
                <li data-target="#bmw_Z4" data-slide-to="1"></li>
                <li data-target="#bmw_Z4" data-slide-to="2"></li>
                <li data-target="#bmw_Z4" data-slide-to="3"></li>
            </ul>

            <!-- The slideshow -->
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/models/BMW/Z4/bmw_Z4_1.jpg" alt="Front">
                    <div class="carousel-caption">
                        <h3>Front-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/BMW/Z4/bmw_Z4_2.jpg" alt="Side">
                    <div class="carousel-caption">
                        <h3>Side-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/BMW/Z4/bmw_Z4_3.jpg" alt="Rear">
                    <div class="carousel-caption">
                        <h3>Rear-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/BMW/Z4/bmw_Z4_4.jpg" alt="interior">
                    <div class="carousel-caption">
                        <h3>Interior-View</h3>
                    </div>
                </div>
            ...
            <a class="carousel-control-prev" href="#bmw_Z4" data-slide="prev">
                <span class="carousel-control-prev-icon"></span>
            </a>
            <a class="carousel-control-next" href="#bmw_Z4" data-slide="next">
        ...
        <div class="container" style="color: white; background: rgba(0, 0, 0, 0.2);">
            <h2>BMW Z4 Key Specifications: </h2>
            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-dark table-hover" style="white-space:nowrap;">
                                ...
                                <tbody style="white-space:nowrap; border: 1px solid white; border-radius:10px">
                                    <tr>
                                        <td>₹ 65.99 Lakh onwards</td>
                                        <td>11.29 to 14.37 kmpl</td>
                                        <td>1998 to 2998 cc</td>
                ...
                <div class="col-sm-6">
                    <h1>BMW Z4 Price</h1>
                    <p>BMW Z4 price starts at ₹ 65.99 Lakh and goes upto ₹ 80.49 Lakh. The price of Petrol version for Z4 ranges between ₹ 65.99 Lakh - ₹ 80.49 Lakh.</p>
                </div>
            </div>
            <br>
            <br>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="model" class="form-control">
                        ...
                        <option value="BMW Z4 sDrive 20i"> Z4 sDrive 20i ₹ 65.99 Lakh </option>
                        <option value="BMW Z4 M 40i"> Z4 M 40i ₹ 80.49 Lakh </option>
                    </select>
                </div>
