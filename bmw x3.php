...
<body>
    <header>
        ...
        <br>
        <br>
        <h3 class="rec3">BMW X3 </h3>
        <div id="bmw_x3" class="carousel slide" data-ride="carousel">

            <!-- Indicators -->
            <ul class="carousel-indicators">
                <li data-target="#bmw_x3" data-slide-to="0" class="active"></li>
                <li data-target="#bmw_x3" data-slide-to="1"></li>
                <li data-target="#bmw_x3" data-slide-to="2"></li>
                <li data-target="#bmw_x3" data-slide-to="3"></li>
            </ul>

            <!-- The slideshow -->
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/models/BMW/X3/bmw_x3_1.jpg" alt="Front">
                    <div class="carousel-caption">
                        <h3>Front-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/BMW/X3/bmw_x3_2.jpg" alt="Side">
                    <div class="carousel-caption">
                        <h3>Side-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/BMW/X3/bmw_x3_3.jpg" alt="Rear">
                    <div class="carousel-caption">
                        <h3>Rear-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/BMW/X3/bmw_x3_4.jpg" alt="interior">
                    <div class="carousel-caption">
                        <h3>Interior-View</h3>
                    </div>
                </div>
            ...
            <a class="carousel-control-prev" href="#bmw_x3" data-slide="prev">
                <span class="carousel-control-prev-icon"></span>
            </a>
            <a class="carousel-control-next" href="#bmw_x3" data-slide="next">
        ...
        <div class="container" style="color: white; background: rgba(0, 0, 0, 0.2);">
            <h2>BMW X3 Key Specifications: </h2>
            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-dark table-hover" style="white-space:nowrap;">
                                ...
                                <tbody style="white-space:nowrap; border: 1px solid white; border-radius:10px">
                                    <tr>
                                        <td>₹ 60.49 Lakh onwards</td>
                                        <td>13.17 to 16.55 kmpl</td>
                ...
                <div class="col-sm-6">
                    <h1>BMW X3 Price</h1>
                    <p>BMW X3 price starts at ₹ 60.49 Lakh and goes upto ₹ 60.90 Lakh. The price of Petrol version for X3 is ₹ 60.49 Lakh and the price of Diesel version for X3 is ₹ 60.90 Lakh.</p>
                </div>
            </div>
            <br>
            <br>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="model" class="form-control">
                        ...
                        <option value="BMW X3 xDrive 30i Luxury Line"> X3 xDrive 30i Luxury Line ₹ 60.49 Lakh </option>
                        <option value="BMW X3 xDrive 20d Luxury Line"> X3 xDrive 20d Luxury Line ₹ 60.90 Lakh </option>
                    </select>
                </div>
