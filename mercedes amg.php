...
<head>
    ...
    <title>Mercedes-Benz AMG 43 Coupe</title>
...
<body>
    <header>
        ...
        <br>
        <br>
        <h3 class="rec3">Mercedes-Benz AMG 43 Coupe </h3>
        <div id="mercedes_amg" class="carousel slide" data-ride="carousel">

            <!-- Indicators -->
            <ul class="carousel-indicators">
                <li data-target="#mercedes_amg" data-slide-to="0" class="active"></li>
                <li data-target="#mercedes_amg" data-slide-to="1"></li>
                <li data-target="#mercedes_amg" data-slide-to="2"></li>
                <li data-target="#mercedes_amg" data-slide-to="3"></li>
            </ul>

            <!-- The slideshow -->
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/models/mercedes/amg/mercedes_amg_1.jpg" alt="Front">
                    <div class="carousel-caption">
                        <h3>Front-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/mercedes/amg/mercedes_amg_2.jpg" alt="Side">
                    <div class="carousel-caption">
                        <h3>Side-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/mercedes/amg/mercedes_amg_3.jpg" alt="Rear">
                    <div class="carousel-caption">
                        <h3>Rear-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/mercedes/amg/mercedes_amg_4.jpg" alt="interior">
                    <div class="carousel-caption">
                        <h3>Interior-View</h3>
                    </div>
                </div>
            ...
            <a class="carousel-control-prev" href="#mercedes_amg" data-slide="prev">
                <span class="carousel-control-prev-icon"></span>
            </a>
            <a class="carousel-control-next" href="#mercedes_amg" data-slide="next">
        ...
        <div class="container" style="color: white; background: rgba(0, 0, 0, 0.2);">
            <h2>Mercedes-Benz AMG 43 Coupe Key Specifications: </h2>
            <div class="row">
                ...
                <div class="col-sm-6">
                    <h1>Mercedes-Benz AMG 43 Coupe Price</h1>
                    <p>Mercedes-Benz AMG GLC 43 Coupe price is ₹ 76.70 Lakh. The price of Petrol version for AMG GLC 43 Coupe is ₹ 76.70 Lakh.</p>
                </div>
            </div>
            <br>
            <br>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="model" class="form-control">
                        ...
                        <option value="Mercedes AMG 43 Coupe 4MATIC"> Mercedes-Benz AMG 43 Coupe 4MATIC ₹ 76.70 Lakh </option>
                    </select>
                </div>
