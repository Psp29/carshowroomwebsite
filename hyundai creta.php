...
<body>
    <header>
        ...
        <br>
        <br>
        <h3 class="rec3">Hyundai Creta </h3>
        <div id="Hyundai_Creta" class="carousel slide" data-ride="carousel">

            <!-- Indicators -->
            <ul class="carousel-indicators">
                <li data-target="#Hyundai_Creta" data-slide-to="0" class="active"></li>
                <li data-target="#Hyundai_Creta" data-slide-to="1"></li>
                <li data-target="#Hyundai_Creta" data-slide-to="2"></li>
                <li data-target="#Hyundai_Creta" data-slide-to="3"></li>
            </ul>

            <!-- The slideshow -->
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/models/Hyundai/Creta/Hyundai_Creta_1.jpg" alt="Front">
                    <div class="carousel-caption">
                        <h3>Front-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Hyundai/Creta/Hyundai_Creta_2.jpg" alt="Side">
                    <div class="carousel-caption">
                        <h3>Side-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Hyundai/Creta/Hyundai_Creta_3.jpg" alt="Rear">
                    <div class="carousel-caption">
                        <h3>Rear-View</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./images/models/Hyundai/Creta/Hyundai_Creta_4.jpg" alt="interior">
                    <div class="carousel-caption">
                        <h3>Interior-View</h3>
                    </div>
                </div>
            ...
            <a class="carousel-control-prev" href="#Hyundai_Creta" data-slide="prev">
                <span class="carousel-control-prev-icon"></span>
            </a>
            <a class="carousel-control-next" href="#Hyundai_Creta" data-slide="next">
        ...
        <div class="container" style="color: white; background: rgba(0, 0, 0, 0.2);">
            <h2>Hyundai Creta Key Specifications: </h2>
            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-dark table-hover" style="white-space:nowrap;">
                                ...
                                <tbody style="white-space:nowrap; border: 1px solid white; border-radius:10px">
                                    <tr>
                                        <td>₹ 9.82 Lakh onwards</td>
                                        <td>17 to 21 kmpl</td>
                                        <td>1353 to 1497 cc</td>
                                        <td>Manual, Automatic (CVT), Automatic (Torque Converter) & Automatic (Dual Clutch)</td>
                                        <td>Petrol & Diesel</td>
                                        <td>5 Seater</td>
                                    </tr>
                                </tbody>
                ...
                <div class="col-sm-6">
                    <h1>Hyundai Creta Price</h1>
                    <p>Hyundai Creta price starts at ₹ 9.82 Lakh and goes upto ₹ 17.33 Lakh. The price of Petrol version for Creta ranges between ₹ 9.82 Lakh - ₹ 17.33 Lakh and the price of Diesel version for Creta ranges between ₹ 10.00 Lakh - ₹ 17.33 Lakh.</p>
                </div>
            </div>
            <br>
            <br>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="model" class="form-control">
                        ...
                        <option value="Hyundai Creta E 1.5 Petrol"> Creta E 1.5 Petrol ₹ 9.82 Lakh </option>
                        <option value="Hyundai Creta E 1.5 Diesel"> Creta E 1.5 Diesel ₹ 10.00 Lakh </option>
                        <option value="Hyundai Creta SX (O) 1.4 Turbo 7 DCT"> Creta SX (O) 1.4 Turbo 7 DCT ₹17.33 Lakh </option>
                        <option value="Hyundai Creta SX (O) 1.4 Turbo 7 DCT Dual Tone"> Creta SX (O) 1.4 Turbo 7 DCT Dual Tone ₹ 17.33 Lakh </option>
                    </select>
                </div>
